...
genai.configure(api_key="AIzaSyCW1FfRYzMgTfaT51QPELn0_POPWaJqHaQ")
...
st.markdown(
    ...
    <div>
        <p class="main-title">Code Reviewer 🤖</p>
...
st.sidebar.header("Code Reviewer🤖")
st.sidebar.markdown(
    """
...
st.sidebar.image("C:/Users/jathi/Streamlit/th.jpg",
    width=300,
)
